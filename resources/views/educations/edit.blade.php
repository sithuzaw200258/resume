                ...
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-primary" role="alert">
                            <h6 class="mb-0">Edit Education</h6>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('school_name') is-invalid @enderror" id="school_name" name="school_name"
                                        value="{{ old('school_name',$education->school_name) }}" placeholder="Enter school name">
                                    @error('school_name')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('school_location') is-invalid @enderror" id="location_location" name="school_location"
                                        value="{{ old('school_location',$education->school_location) }}" placeholder="Enter school location">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('graduated_year') is-invalid @enderror"
                                        id="graduated_year" name="graduated_year" value="{{ old('graduated_year',$education->graduated_year) }}"
